    ...
    \begin{titlepage}
        ...
        \begin{minipage}{0.45\textwidth}
            \begin{flushleft} \large
                \textbf{Realizado por:}\\
                Rafael Conceição Narciso (n.º 24473)\\
                Hugo Alexandre Assis Diogo (n.º 18803)
            \end{flushleft}
        \end{minipage}
        \begin{minipage}{0.45\textwidth}
...
A aplicação foi desenvolvida na linguagem \textbf{Python} devido à sua versatilidade na manipulação de \textit{strings} e \textit{bytes}. Para a interface gráfica utilizou-se a biblioteca \textbf{[Inserir Biblioteca: ex: Tkinter/PyQt]}, e para as cifras modernas a biblioteca \textbf{Cryptography/PyCryptodome}.
